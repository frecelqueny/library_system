...
public class Registration extends javax.swing.JFrame {
    ...
    public Registration(boolean fromDashboard) {
    initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(360, 160, 100, 30);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Role:");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(340, 320, 100, 30);
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(340, 280, 160, 30);
        ...
        jLabel10.setBounds(350, 200, 80, 30);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        // Validate password strength (min 8 chars, 1 upper, 1 lower, 1 digit, and 1 special char)
        ...
        try {
            // Create a PreparedStatement to safely insert data into the database
            String query = "INSERT INTO users (first_name, last_name, username, email, password, role, status) "
                         + "VALUES(?, ?, ?, ?, ?, ?, ?)";
            ...
            try (PreparedStatement stmt = con.getConnection().prepareStatement(query)) {
                ...
                stmt.setString(7, "Pending");  // Set the status to "Pending"
                ...
                if (result == 1) {
                    ...
                    new login().setVisible(true);  // Open the login screen after successful registration
